            ...
            <div class="col-md-6">
              <div class="recom-item">
                <div class="recom-media"><a href="hotels-details.html">
                  ...
                  <div class="location"><i class="flaticon-suntour-map"></i>Alkhalil Courtyard</div>
                </div>
                <!-- Recomended Content-->
                <div class="recom-item-body"><a href="hotels-details.html">
                  ...
                  <p class="mb-30">2 restaurants, a coffee shop/cafe, and self parking are available at</p><a href="hotels-details.html" class="recom-button">Read more</a><a href="hotels-details.html" class="cws-button small alt">Book now</a>
                </div>
                <!-- Recomended Image-->
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="recom-item">
                <div class="recom-media"><a href="hotels-details.html">
                  ...
                  <div class="location"><i class="flaticon-suntour-map"></i>Ibrahim Al Khalil Road</div>
                </div>
                <!-- Recomended Content-->
                <div class="recom-item-body"><a href="hotels-details.html">
