            ...
            <div class="col-12">
                <div class="card">
                    ...
                    @endif
                        ...
                        <form class="form-horizontal" wire:submit.prevent="storeSliders">
                            {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-6">

                                <div class="mb-3">
                                    <label for="newimage" class="form-label">Slider Image</label>
                                    <input type="file" id="newimage" class="form-control" wire:model="newimage">
                                    @if($newimage)
                                        <img src="{{ $newimage->temporaryUrl() }}" width="120"/>
                                    @else
                                        <img src="{{ asset('assets/frontend/pic/slider/main') }}/{{ $image }}" width="120"/>
                                    @endif
                                ...
                                <div class="mb-3">
                                    <label for="newinfoImage" class="form-label">Info Image</label>
                                    <input type="file" id="newinfoImage" class="form-control" wire:model="newinfoImage">
                                     @if($newinfoImage)
                                        <img src="{{ $newinfoImage->temporaryUrl() }}" width="120"/>
                                    @else
                                        <img src="{{ asset('assets/frontend/pic') }}/{{ $infoImage }}" width="120"/>
                                    @endif
                                    @error('newinfoImage') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($newinfoImage2)
                                        <img src="{{ $newinfoImage2->temporaryUrl() }}" width="120"/>
                                    @else
                                        <img src="{{ asset('assets/frontend/pic') }}/{{ $infoImage2 }}" width="120"/>
                                    @endif
                                    @error('newinfoImage2') <span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="mb-3">
